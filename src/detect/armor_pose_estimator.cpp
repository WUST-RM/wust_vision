...
ArmorPoseEstimator::extractArmorPoses(const std::vector<ArmorObject> &armors,
            ...
            (temp_type))) 
  {
   ...
   sortPnPResult(armor, rvecs, tvecs ,temp_type);
      ...
      Eigen::Quaterniond additional_roll(Eigen::AngleAxisd(roll_angle, Eigen::Vector3d::UnitX()));
      //Eigen::Quaterniond additional_yaw(Eigen::AngleAxisd(yaw_angle, Eigen::Vector3d::UnitY()));
      ...
      // std::cout << "Yaw: " << rpy.z() * 180 / M_PI << " degrees" << std::endl;
